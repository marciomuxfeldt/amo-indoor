    ...
    <div class="pairing-container">
      ...
      >
        ...
        >
          ...
          <p class="modal-text">
            Esta TV já está pareada com o device:
          </p>
          <div class="current-device-info">
            <p><strong>Nome:</strong> {{ currentDeviceName }}</p>
            <p><strong>Layout:</strong> {{ currentDeviceLayout }}</p>
          </div>
          <p class="modal-text">
...
const currentDevice = computed(() => {
  ...
  return devicesStore.devices.find(d => d.id === currentDeviceId.value)
})
const currentDeviceName = computed(() => currentDevice.value?.name || 'Desconhecido')
const currentDeviceLayout = computed(() => {
  const layout = currentDevice.value?.layout_type || 'default'
